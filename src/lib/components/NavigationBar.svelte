...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  <div class="container-fluid">
    <div class="d-flex align-items-center">
      ...
      {/if}
      <a href="/requests" class="nav-link ms-3" class:active={currentPage === 'requests'}>Requests</a>
      <a href="/history" class="nav-link ms-3" class:active={currentPage === 'history'}>History</a>
      <a href="/tokens" class="nav-link ms-3" class:active={currentPage === 'tokens'}>Tokens</a>
      <a href="/about" class="nav-link ms-3" class:active={currentPage === 'about'}>About</a>
    </div>
  </div>
</nav>
